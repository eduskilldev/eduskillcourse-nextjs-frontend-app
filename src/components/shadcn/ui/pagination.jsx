...
const PaginationContent = React.forwardRef(({ className, ...props }, ref) => <ul ref={ref} className={cn('flex flex-row items-center justify-between w-full', className)} {...props} />);
...
const PaginationLink = ({ className, isActive, size = 'icon', ...props }) => (
	<Link
		...
		className={cn(
			buttonVariants({
				variant: isActive ? 'outline' : 'eduskill',
				size,
			}),
			className,
		)}
