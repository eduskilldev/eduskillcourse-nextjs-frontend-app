function ProgrammingBasicIcon({ className }) {
	return (
		<div className='p-3 bg-[#E9FCE7] rounded-[0.625rem]'>
			<svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' style={{ msFilter: '' }} className='fill-[#15C131]'>
...
export default ProgrammingBasicIcon;
